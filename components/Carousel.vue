  ...
  <div v-swiper:mySwiper="swiperOption" class="swiper-container--hero">
    <div class="swiper-wrapper">
      <div v-for="(slide, index) in slides" :key="index" class="swiper-slide">
        <div :style="slide.background" class="hero__container hero__container--big">
        ...
        <div :style="slide.smallMainBackground" class="hero__container hero__container--small">
          <div class="hero__image-container">
            <figure class="hero__content-figure--small">
              <picture>
                <source :srcSet="require('~/assets/images/' + slide.image + '?webp')" type="image/webp">
                <source :srcSet="require('~/assets/images/' + slide.image + '?resize')" type="image/png">
                <img :src="require('~/assets/images/' + slide.image + '?sqip')" :alt="slide.title" :class="'hero__content-image--small--' + (index + 1)" class="hero__content-image--small">
              </picture>
            </figure>
            <div v-if="slide.intersection" :style="slide.smallContentBackground" class="hero__content-intersection" />
          </div>
          <div :style="slide.smallContentBackground" class="hero__content-container">
            <div class="hero__content-title">
              <h1 v-html="slide.title" class="heading-1" />
            </div>
            <div class="hero__content-description">
      ...
      slides: [
        {
          ...
          image: 'bg-1.png',
          smallMainBackground: 'background: radial-gradient(39.45% 101.38% at 60.55% 69.54%, #494B4E 0.36%, #3D4347 100%);',
        ...
        },
        {
          ...
          description: 'Универсальное решение финансовых вопросов',
          image: 'bg-2.png',
          smallMainBackground: 'background: linear-gradient(206.14deg, #7977F1 -25.16%, #3A3897 100%);',
          smallContentBackground: '',
          fullImage: false,
          intersection: false
        },
        {
          ...
          smallContentBackground: 'background: linear-gradient(225.88deg, #656F82 0.76%, #4A5363 100%)',
          fullImage: false,
          intersection: true
        },
        {
          ...
          image: 'bg-4.png',
          smallMainBackground: 'background: linear-gradient(242.48deg, #2EA9DD -44.58%, #7329D8 113.08%)',
          smallContentBackground: 'background: linear-gradient(223.93deg, #2EA9DD -44.58%, #7329D8 113.08%)',
          fullImage: false,
          intersection: true
        },
        {
          ...
          image: 'bg-5.png',
          smallMainBackground: 'background: linear-gradient(232.74deg, #03CD0B -102.38%, #0081CA 100%)',
          smallContentBackground: 'background: linear-gradient(213.42deg, #03CD0B -102.38%, #0081CA 100%)',
          fullImage: false,
          intersection: true
        }
        // {
